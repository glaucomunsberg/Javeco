/**
 * 	Time foi criada para ser uma alternativa ao GregorianCalendar ou até
 * 		mesmo um "extends". No sistema, ele já era apresentado nas outras
 * 		versões e estava disponível ja no package com.glaucorobeto.Time
 * 		porém foi trazido para dentro do Sistema para tornar o programa
 * 		mais legivel e portátil
 * 
...
public class Time 
{
	...
	public void setTime(int h, int m, int s, int d, int M, int a)
	{
		...
		mes 	= 	((M >= 0 && M <= 12)? M : 0 );
		dia 	= 	checarDia(d);
		Log.addLog(String.format("Time modificado %02d:%02d:%02d %02d/%02d/%02d.", segundo, minuto,hora,dia,mes,ano));
	}
	...
	private int checarDia( int dia)
	{
		...
		System.err.printf("Dia %d não pode ser mudado para %d.\n", this.dia, dia);
		return this.dia;
	}
