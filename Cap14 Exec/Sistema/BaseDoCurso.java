...
public class BaseDoCurso 
{
	...
	LogDoSistema log = new LogDoSistema();
	...
	public BaseDoCurso()
	{
		...
		{
			log.openFile("Cap14 Exec/logDoSistema.txt");
	 ...
	 */
	public BaseDoCurso( String nomeDoCurso, String objetivoCurso ,int numAlunos, int numMaxDeAluno, String nomeProfessor, String[] gradeNomes, int[] gradeNotas, int[] gradeConceitos, String localDoLog)
	{
		if( this.chkInicializacaoLog == false )
		{
			if( localDoLog == null )
